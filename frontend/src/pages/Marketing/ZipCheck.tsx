					...
					<div className="container mx-auto max-w-6xl">
						...
						<div className="grid md:grid-cols-2 gap-10 max-w-4xl mx-auto">
							{plans.map((plan, index) => (
								...
								>
									<motion.div
										className="relative flex flex-col glass-neon rounded-3xl p-10 pl-14 h-full border-2 border-[#11998e]/40"
										animate={{
											boxShadow: [
												'0 -12px 40px rgba(59, 130, 246, 1), 12px 0 40px rgba(249, 115, 22, 1), 0 12px 40px rgba(17, 153, 142, 0.9), -12px 0 40px rgba(56, 239, 125, 0.9)',
												'12px 0 40px rgba(59, 130, 246, 1), 0 12px 40px rgba(249, 115, 22, 1), -12px 0 40px rgba(17, 153, 142, 0.9), 0 -12px 40px rgba(56, 239, 125, 0.9)',
												'0 12px 40px rgba(59, 130, 246, 1), -12px 0 40px rgba(249, 115, 22, 1), 0 -12px 40px rgba(17, 153, 142, 0.9), 12px 0 40px rgba(56, 239, 125, 0.9)',
												'-12px 0 40px rgba(59, 130, 246, 1), 0 -12px 40px rgba(249, 115, 22, 1), 12px 0 40px rgba(17, 153, 142, 0.9), 0 12px 40px rgba(56, 239, 125, 0.9)',
												'0 -12px 40px rgba(59, 130, 246, 1), 12px 0 40px rgba(249, 115, 22, 1), 0 12px 40px rgba(17, 153, 142, 0.9), -12px 0 40px rgba(56, 239, 125, 0.9)'
											]
										...
										whileHover={{
											boxShadow: '0 0 60px rgba(59, 130, 246, 1), 0 0 50px rgba(249, 115, 22, 1), 0 0 40px rgba(17, 153, 142, 1)'
										}}
										transition={{
											boxShadow: {
												duration: 3,
									...
									>
										<div className="absolute -top-4 left-1/2 -translate-x-1/2 px-6 py-2 rounded-full bg-gradient-to-r from-[#11998e] to-[#38ef7d] text-white text-sm font-semibold shadow-lg">
											추천
										</div>

										<h3 className="text-4xl font-bold mb-3 mt-2" style={{
											background: 'linear-gradient(135deg, #11998e, #38ef7d)',
											WebkitBackgroundClip: 'text',
											WebkitTextFillColor: 'transparent'
										}}>
										...
										<ul className="space-y-4 mb-8 flex-grow">
											{plan.features.map((feature, i) => (
												<li key={i} className="flex items-start gap-3 text-base">
													<CheckCircle2 className="w-6 h-6 text-[#38ef7d] mt-0.5 flex-shrink-0" />
					...
					<div className="container mx-auto max-w-5xl text-center">
						...
						>
							...
							<div className="flex flex-col sm:flex-row gap-6 justify-center">
								...
								<MagneticButton
									className="px-14 py-6 glass-neon rounded-full font-bold text-2xl text-[#38ef7d] neon-border"
									onClick={scrollToQuoteExample}
									intensity={0.4}
								>
									분석 예시 보기
