		...
		<section id="examples" className="relative overflow-hidden">
			...
			<div className="relative z-10 max-w-7xl mx-auto px-8 py-24">
				<div className="grid md:grid-cols-2 gap-16 items-center">
					{/* Left: Summary */}
					<div>
						<span className="text-forest-200 font-medium text-sm tracking-widest uppercase">
							Real Example
						</span>
						<h2 className="font-outfit text-4xl font-bold text-white mt-3 mb-6 tracking-tight">
							실제 분석 예시
						</h2>
						...
						<div className="grid grid-cols-2 gap-4 mb-8">
							<div className="bg-white/10 backdrop-blur-sm rounded-xl p-5 border border-white/10">
								...
								<p className="text-2xl font-bold text-white font-outfit">
									...
									<span className="text-base font-normal text-white/50">만원</span>
								</p>
							</div>
							<div className="bg-white/10 backdrop-blur-sm rounded-xl p-5 border border-white/10">
								<p className="text-white/50 text-xs mb-1">적정 견적</p>
								<p className="text-2xl font-bold text-forest-300 font-outfit">
									{quoteExampleSummary.adjusted}
									<span className="text-base font-normal text-forest-300/60">만원</span>
								</p>
							</div>
							<div className="bg-white/10 backdrop-blur-sm rounded-xl p-5 border border-white/10">
								<p className="text-white/50 text-xs mb-1">절감액</p>
								<p className="text-2xl font-bold text-green-300 font-outfit">
									{quoteExampleSummary.savings}
									<span className="text-base font-normal text-green-300/60">만원</span>
								</p>
							</div>
							<div className="bg-white/10 backdrop-blur-sm rounded-xl p-5 border border-white/10">
								...
								<p className="text-2xl font-bold text-green-300 font-outfit">
									...
									<span className="text-base font-normal text-green-300/60">%</span>
								</p>
							</div>
						</div>
						...
						<a
							href="#"
							className="inline-block px-6 py-3 bg-white/15 backdrop-blur-sm text-white rounded-xl font-medium border border-white/20 hover:bg-white/25 transition"
						>
							전체 리포트 예시 보기 &rarr;
						</a>
					</div>
